        ...
        <div className="col-lg-8 col-md-6 col-sm-12 col-xs-12 ">
          <div className="">
            ...
            <p className={Style.pera}>
              ...
              omnis. Delectus blanditiis accusantium sequi nesciunt veritatis,
              explicabo repudiandae qui animi? Dolor consequatur, veritatis
              expedita ratione saepe ? Sapiente, quam.
            </p>
          </div>
        </div>
